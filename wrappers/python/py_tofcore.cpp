...
PYBIND11_MODULE(pytofcore, m) {
    ...
    py::class_<tofcore::Sensor>(m, "Sensor")
        ...
        .def("set_integration_time", &tofcore::Sensor::setIntegrationTime, "Set the integration time on the sensor", py::arg("low"), py::call_guard<py::gil_scoped_release>())
        .def("set_integration_times", &tofcore::Sensor::setIntegrationTimes, "Set the integration time parameters on the sensor", py::arg("low"), py::arg("mid"), py::arg("high"), py::call_guard<py::gil_scoped_release>())
